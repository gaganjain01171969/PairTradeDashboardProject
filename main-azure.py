...
BASE_DIR = "/site/wwwroot/pairtradeaptml/web-application"
...
def get_pair_trade():
 ...
 #           plt.suptitle(short_symbol + " Minus " + long_symbol + '\n(Overly Bullish Minus Overly Bearish)')
...
#            plt.savefig(img, format='png')
  ...
  #          plt.suptitle('Overly Bearish - Buy: ' + long_symbol)
   ...
   #         plt.savefig(img, format='png')
    ...
    #        plt.suptitle('Overly Bullish - Sell: ' + short_symbol)
